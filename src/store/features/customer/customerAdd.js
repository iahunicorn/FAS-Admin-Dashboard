      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            >
              <CCol md={2}>
                <CFormLabel htmlFor="customerName">Customer ID</CFormLabel>
                <CFormInput
                  type="text"
                  id="customerId"
                  defaultValue="0001"
              ...
              <CCol md={6}>
                ...
                <CFormInput type="text" id="billToAddress1" />
                <CFormFeedback valid></CFormFeedback>
              </CCol>
              <CCol md={6}>
                <CFormLabel htmlFor="billToAddress2">Bill To Address 2</CFormLabel>
                <CFormInput type="text" id="billToAddress2" />
                <CFormFeedback valid></CFormFeedback>
              </CCol>
              <CCol md={3}>
              ...
              <CCol md={3}>
                ...
                <CFormInput type="text" id="billToPostalCode" />
                <CFormFeedback valid></CFormFeedback>
              </CCol>
              <CCol md={12}>
                <CFormLabel htmlFor="shippingAddress">Shipping Address</CFormLabel>
                <CFormInput type="text" id="shippingAddress" />
                <CFormFeedback valid></CFormFeedback>
              </CCol>
              <CCol xs={12}>
